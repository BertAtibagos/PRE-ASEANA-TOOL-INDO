...
<p class="path-name-height">Export | 
        <span style="font-weight:bold">
            <i class="fas fa-file-download"></i>&nbspExport by YOY
        </span>
    </p><br>
...
if($alpha_srt=="true"){
$sql = "SELECT * FROM businessdt_tbl WHERE REG_DATE BETWEEN '$year1-01-01' AND '$year2-12-31' ORDER BY BUSINESS_NAME ASC";
...
$query = "SELECT * FROM businessdt_tbl WHERE REG_DATE BETWEEN '$year1-01-01' AND '$year2-12-31' ORDER BY BUSINESS_NAME ASC";
...
while($row = mysqli_fetch_array($result1)){
    ...
    $user_arr[] = array($reg_id,$bs_name,$txpyr,$type,$add,$brgy,$bs_line,$actv,$reg_date);
        ...
        $sql = "SELECT * FROM businessdt_tbl WHERE REG_DATE BETWEEN '$year1-01-01' AND '$year2-12-31'";
        $result = mysqli_query($conn, $sql);
        ...
        $query = "SELECT * FROM businessdt_tbl WHERE REG_DATE BETWEEN '$year1-01-01' AND '$year2-12-31'";
        $result1 = mysqli_query($conn,$query);
        $user_arr = array();
        while($row = mysqli_fetch_array($result1)){
            $reg_id = $row['REG_ID'];
